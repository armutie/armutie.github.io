    ...
    foods: {
      ...
      items: {
        ...
        properties: {
          ...
          estimatedWeightGrams: { type: "number", exclusiveMinimum: 0, maximum: 5000 },
          minimumWeightGrams: { type: "number", exclusiveMinimum: 0, maximum: 5000 },
          maximumWeightGrams: { type: "number", exclusiveMinimum: 0, maximum: 5000 },
          confidence: { type: "number", minimum: 0, maximum: 1 },
    ...
    followUpQuestions: {
      ...
      items: {
        ...
        properties: {
          ...
          relatedFoodTemporaryId: { type: ["string", "null"] },
        },
      },
    },
